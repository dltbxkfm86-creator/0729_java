...
public class Casting {
	 ...
	 * => 자료형이 다른데 연산을 하고싶다? => 둘 중에 하나를 "형변환"해서 나머지 하나와 동일하게 맞춤
	 * 
	...
	public void autoCasting() {
		//System.out.println("이 내용울 콘솔창에 출력해보세요 실습 시작");
		...
		double doubleNum = (double)intNum;	// intNum의 값 10을 double형으로 바꿔서 doubbleNum이라는 변수에 넣음
		System.out.println(doubleNum);		
		System.out.println(intNum);
		
		// 2.int(정수, 4Byte) -> long(8Byte, 정수)
		int bigInteger = 120;
		long smallLong = /*(long)*/bigInteger; 	// 자동 형변환
		...
		System.out.println((char)2 == '2'); // false (2 == (int)'2') 와 같음
