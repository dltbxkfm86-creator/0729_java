...
public class B_KeyboardInput {
	public void inputTest() {
		...
		// nextInt() : 정수형 입력 값을 받음
		// nextDouble() : 실수형 입력 값을 받음
		int quantity = sc.nextInt();
		System.out.println(menu + "를 " + quantity + "개 주문하셨습니다.");
		...
		System.out.println(menu + "를 " + quantity + "개를" + address + "로 배달합니다.");
