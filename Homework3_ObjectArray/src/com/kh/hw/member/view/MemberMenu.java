...
public class MemberMenu {
	...
	public void mainMenu() {
		while(true) {
			...
			if(count != 10) {
				...
				System.out.println("회원 수가 꽉 찼기 때문에 일부메뉴만 오픈됩니다");
			}
	...
	private void findAll() {
		...
		System.out.println();
		System.out.println("회원 전체 조회 서비스입니다");
	...
	private void insertMember() {
		...
		// 아이디 => 중복이 발생하면 안되므로 mc의 메소드를 호출해서 중복확인
		//			중복이 아닐시만 pass
		String id = " ";
		while(true) {
	...
	private void deleteMember() {
		...
		System.out.println("삭제하실 회원의 비밀번호를 입력하세요");
