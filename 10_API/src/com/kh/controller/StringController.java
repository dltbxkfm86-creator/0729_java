...
public class StringController {
	...
	public void method1() {
		...
		// System.identityHashCode(참조형 변수)
	...
	public void method4() {
		...
		// StringBuffer
		// Buffer == 임시저장공간
		// 문자열은 불변객체라서 내용물이 변경 될 때 마다 새로운 공간을 할당해서 집어넣는다
	...
	public void split() {
		...
		// 배열의 요소를 수정할 수 없음, index에 직접 접근할 수 없음
