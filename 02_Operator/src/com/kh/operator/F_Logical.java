...
public class F_Logical {
	...
	public void method1() {
		...
		int num = sc.nextInt();
		// System.out.println(num); // 변수 찍어보기
		...
		System.out.println("정수 값이 0보다 크면서 짝수인가요? " + result);
	}
	...
	public void method2() {
		...
		int num = sc.nextInt();
		//출력해보세요.
		System.out.println("입력한 정수 값 : " + num);
		...
		// 사용자가 입력한 값이 1 ~ 100 사이의 값인지를 판별하여 출력하기
	...
	public void method3() {
		...
		*/
		...
		System.out.println("입력 받은 값이 A 또는 a인가요? " + result);
	...
	public void tip() {
		...
		boolean result2 = (num < 0) && (num == 10); // 앞이 false이면 뒤에가 true나 false가 나와도 false이므로 계산을 안함
