...
public class Member {
	 ...
	 * 2. 매개변수가 존재하는 생성자 => 객체를 생성과 동시에 유효하게 만들기 위해서
	 * 
	 */
	...
	/*
	 * 1. 반드시 생성자의 이름을 클래스의 이름과 동일하게 작성해야 함(대/소문자 주의)
	 ...
	 * 우리반게시판에 동일한 형식으로 제출
	 * 
	 * 제한 시간 : 08 /  08 -- 07:59 까지
	 */
	
	// [ 메소드부 ]
	// 16:00는 여러분들이 힘든 시간이기 때문에, 실습을 드리겠습니다
	// 모든 필드에 대한 getter() / setter() 만들기 + 모든 필드의 정보를 
	// 합쳐서 반환하는 info() 만들기
