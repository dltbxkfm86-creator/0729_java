...
public class StaticController {
	...
	public static String str = "static filed"; // static 특) 누워있음 
	String str2;
	
	// 생성 시점 : 프로그램 실행과 동시에 메모리의 static영역에 할당
	// 소멸 시점 : 프로그램 종료!
	// 객체를 생성하지 않고 static영역에 할당
	 ...
	 * => 예약어 순서는 상관없음 public final static 으로 작성해도 괜찮음
	 * => 한 번 지정한 값을 고정해서 쓰겠다. 무조건 초기화를 해야함
	 * 
	 * static : 공유의 목적
	 * final : 한 번 초기화하고 바꾸지 않음
	 * 
	 * 값이 변경되면 큰일 나는 고정적인 값들을 메모리(static)영역에 올려놓고 공유해서 쓸 목적
	 * 
