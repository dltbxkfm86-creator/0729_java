...
public class MethodController {
	...
	/*
	 * 메소드(Method) == 멤버 함수 : 입력값을 가지고 특정동작을 수행한 뒤 결과물을 내놓음
	 * 
	 ...
	 * 2. 모듈화
	 * 
	 * 객체지향 프로그래밍에서의 메소드란 : 객체가 수행할 수 있는 행동의 정의한 코드 블록
	 * 
	 * 특정 자료형에서만 사용이 가능한 함수
	 * 
	 * [ 표현법 ]
	 * 
	 * 접근제한자 예악어 반환형 메소드식별자(매개변수의자료형 매개변수식별자) {
	 * 
	 * 			수행할 코드;
	 * 
	 * 			return 반환값;
...
//	
	public void method4(int num) {
		...
		System.out.println("전달받은 값 + 100" + (num + 100));
	}
	
	// 4. 매개변수도 존재하고 반환값도 존재하는 메소드
	public int method5(int num) {
		System.out.println("매개변수와 반환값이 존재");
		return num + 50;
	}
